...
public enum CountryCode implements CountryCodeInterface
{
     ...
     * @since 1.23
     */
    public static CountryCodeInterface getByAlpha2Code(String code)
    {
     ...
     * @since 1.23
     */
    public static CountryCodeInterface getByAlpha3Code(String code)
    {
     ...
     * @since 1.23
     */
    public static CountryCodeInterface getByAlpha4Code(String code)
    {
